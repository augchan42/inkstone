...
| **image-to-scene** | Convert ink paintings into video generation motion prompts — 5 motion categories, 6 motion rules, Seedance 2.0 API reference, QwenCloud Token Plan (HappyHorse 1.1) run notes |
...
| Skill | Description |
|-------|-------------|
| **oss-licence-audit** | Open-source licence inventory (SBOM-style) with copyleft triage — deterministic Node script reads manifests and node_modules, classifies licences, flags sharp edges for lawyer review. Inventory, never a legal opinion |
