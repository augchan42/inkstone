# Yilin Prompt Examples

Validated reference prompts — read this file when generating prompts to calibrate tone and structure.

---

## Ink Painting Mode

8 references, one or two per style.
...
### ink-landscape (water/travel)

"A steep mountain path switchbacking upward between dark pines. A figure leads an ox by rope, both leaning into a wall of driving snow. Cliff face on one side, drop on the other. Above, the peak is lost in storm cloud. Below, the path descends to a warm valley where rooftops glow amber through the snow veil. Chinese ink painting."

### bold-action (animal)

"A massive tiger crouches low at a rocky stream, belly to the ground, confronted by a small hedgehog bristling with quills on the opposite bank. Behind them, a gorge opens — water surges through a narrow rock gate, white spray exploding upward. The tiny hedgehog facing the great tiger, and beyond both, the rushing water. Chinese ink painting."

### cosmic-night (celestial)

"An immortal sage ascending from a dark mountain pool on the back of a celestial horse, trailing wisps of cloud. Above, the constellation Xuanyuan glows in a deep indigo sky. The horse's mane streams upward like white fire. Below, the pool reflects the starfield perfectly — sky above, sky below. Gold stars against indigo, the white horse ascending between two skies. Chinese ink painting."

---

## Tech-Noir Mode

8 references, one or two per style. Each is a tech-noir re-rendering of a classical subject — the verse's content stays, the visual register changes.
...
### terminal-dark (interior)

"A figure sits alone in a server room after hours, face lit from below by a single amber diagnostic panel. Rows of dark rack units recede into blackness on both sides, status LEDs extinguished. Overhead, a ventilation duct drips condensation that catches the green standby light of a lone active chassis. The silence is heavy — the hum has stopped. Phosphor-green tech-noir, CRT scanlines, deep blacks."
...
"A steep fire-escape stairway zigzagging upward between concrete walls threaded with cable bundles. A figure leads a loaded hand-cart by rope, both leaning into driving rain. Brick wall on one side, drop to the alley on the other. Above, the roofline is lost in signal fog. Below, the alley descends to a warm basement where a doorway glows amber through the rain veil. Phosphor-green tech-noir, CRT scanlines, deep blacks."
...
"An immortal ascending from a dark rooftop water tank on the back of a mechanical horse, trailing wisps of exhaust vapor. Above, satellite dishes and antenna spires frame a deep indigo sky where aircraft warning lights pulse gold. The horse's mane streams upward like white arc-weld sparks. Below, the water tank reflects the city lights perfectly — sky above, sky below. Gold signals against indigo, the iron horse ascending between two skies. Phosphor-green tech-noir, CRT scanlines, deep blacks."
